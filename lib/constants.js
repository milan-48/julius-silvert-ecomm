...
/** Homepage — “Center of the Plate Proteins” rail (swap for API later). */
export const CENTER_PLATE_SECTION = {
  title: "Center of the Plate Proteins",
  subtitle: "Essential cuts for every meal.",
  viewAllLabel: "View All",
  viewAllHref: "/meat-poultry",
};

/** ADD-only cards (no CASE/PC row) to match plate-proteins layout. */
export const CENTER_PLATE_PRODUCTS = [
  {
    id: "cop-1",
    slug: "cop-pork-tenderloin-5x2lb",
    imageSrc:
      "https://images.unsplash.com/photo-1602470520998-f4a60889a0e5?w=640&q=80",
    imageAlt: "Pork tenderloin in a pan",
    tier: "STANDARD",
  ...
  {
    id: "cop-2",
    slug: "cop-prime-ribeye-steaks-4ct",
    imageSrc:
      "https://images.unsplash.com/photo-1544025162-d76694265947?w=640&q=80",
    imageAlt: "Raw ribeye steaks on a rack",
    tier: "STANDARD",
  ...
  {
    id: "cop-3",
    slug: "cop-boneless-pork-loin-2ct",
    imageSrc:
      "https://images.unsplash.com/photo-1558030006-450675393462?w=640&q=80",
    imageAlt: "Fresh pork cuts",
    tier: "STANDARD",
...
/** Homepage — brand logo wall (names from partner collage; swap for logo assets / API). */
export const BRAND_PARTNERS_SECTION = {
  title: "Our Brand Partners",
  subtitle: "We partner with the best to bring you quality",
};

/**
 * Partner names from the brand collage (screenshot 1). Each row is rendered as its own card
 * via `BrandPartnerCard` (screenshot 2 style: white pill tiles, bold caps type).
 */
export const BRAND_PARTNERS = [
  { id: "bp-boiron", name: "Les Vergers Boiron" },
  { id: "bp-bridor", name: "Bridor" },
  { id: "bp-leidys", name: "Leidy's Premium Meats" },
  { id: "bp-calabro", name: "Calabro" },
  { id: "bp-kikkoman", name: "Kikkoman" },
  { id: "bp-bobs", name: "Bob's Red Mill" },
  { id: "bp-smoking-goose", name: "Smoking Goose" },
  { id: "bp-prop-peller", name: "Prop & Peller" },
  { id: "bp-jasper-hill", name: "Jasper Hill Farm" },
  { id: "bp-north-country", name: "North Country Smokehouse" },
  { id: "bp-lebus", name: "LeBus" },
  { id: "bp-micfood", name: "MICfood" },
  { id: "bp-castle-valley", name: "Castle Valley Mill" },
  { id: "bp-charbonneaux", name: "Charbonneaux-Brabant" },
  { id: "bp-principe", name: "Principe" },
  { id: "bp-monin", name: "Monin" },
  { id: "bp-boylan", name: "Boylan Bottling Co" },
  { id: "bp-cabot", name: "Cabot Creamery" },
  { id: "bp-beyond", name: "Beyond Meat" },
  /** Demo outbound link (mock had one highlighted partner). */
  { id: "bp-marukan", name: "Marukan", href: "https://www.marukan-usa.com/" },
  { id: "bp-fermin", name: "Fermín" },
  { id: "bp-saratoga", name: "Saratoga" },
  { id: "bp-davids", name: "David's Cookies" },
  { id: "bp-barry-callebaut", name: "Barry Callebaut" },
];

/**
 * Category / PLP page — “Shop by” accordion (demo facets; swap for API).
 * `label` is shown as in the design (some all-caps).
 */
export const CATEGORY_PLP_SHOP_BY_GROUPS = [
  {
    id: "brand",
    title: "Brand",
    defaultOpen: true,
    options: [
      { id: "beef-palace", label: "BEEF PALACE" },
      { id: "meat-palace", label: "MEAT PALACE" },
      { id: "chef-meat", label: "CHEF MEAT" },
      { id: "bakers-best", label: "BAKER'S BEST" },
    ],
  },
  {
    id: "milk",
...
/** Category PLP sort dropdown (demo). */
export const CATEGORY_PLP_SORT_OPTIONS = [
  { value: "sku-asc", label: "SKU: Low to High" },
...
/** Demo PLP rows — merges homepage pools, deduped by `slug` and title. */
export function getCategoryListingProductPool() {
...
/** Site footer — shown on every page via `SiteFooter`. */
export const SITE_FOOTER = {
  tagline: `Premium meats since ${SITE_CONFIG.estYear}`,
  contact: {
    heading: "Contact Us",
    lines: [
      "1234 Market Street",
  ...
  social: {
    heading: "Follow Us",
    links: [
      { label: "Facebook", href: "https://www.facebook.com/juliussilvert", icon: "facebook" },
      {
        label: "LinkedIn",
        href: "https://www.linkedin.com/company/julius-silvert-inc/",
        icon: "linkedin",
      },
      { label: "Instagram", href: "https://www.instagram.com/juliussilvert/", icon: "instagram" },
    ],
  },
};
